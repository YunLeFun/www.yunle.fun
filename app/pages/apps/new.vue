    ...
    <div v-else class="max-w-xl mx-auto space-y-6">
      ...
      <AppPageCard class="p-6">
        <form class="space-y-5" @submit.prevent="handleSubmit">
          ...
          <!-- GitHub 仓库 -->
          <AppFormField label="GitHub 仓库" hint="可选，应用的源码仓库">
            <GitHubRepoField
          ...
          <div class="flex items-center justify-between py-2">
            <div>
              <p id="new-app-public-label" class="text-sm font-medium">
                公开应用
              </p>
              <p id="new-app-public-description" class="text-xs text-muted">
                公开后其他用户可以查看此应用
              </p>
            </div>
            <AppSwitch
              v-model="form.isPublic"
              aria-labelledby="new-app-public-label"
              aria-describedby="new-app-public-description"
            />
          </div>
