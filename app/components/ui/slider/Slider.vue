...
<template>
  ...
  >
    ...
    <SliderThumb
      ...
      :data-vertical="props.orientation === 'vertical' ? '' : undefined"
      class="border-ring ring-ring/50 relative size-4 rounded-full border bg-background shadow-sm transition-[color,box-shadow] after:absolute after:-inset-2 hover:ring-3 focus-visible:ring-3 focus-visible:outline-hidden active:ring-3 block shrink-0 select-none disabled:pointer-events-none disabled:opacity-50"
    />
  </SliderRoot>
</template>
